...
export default async function PropertyPage({
  ...
  const propertyGallery: Record<string, { src: string; alt: string }[]> = {
    "whole-farm": [
      ...
      { src: "/images/properties/lodge-living-room.jpg", alt: "Lodge living room with leather sofas" },
      { src: "/images/properties/cottage-kitchen.jpg", alt: "Cottage kitchen with spiral staircase" },
      { src: "/images/properties/gallery-7.jpg", alt: "Aerial view of Highland Farms property" },
    ],
    lodge: [
      { src: "/images/properties/cottage.jpg", alt: "William Wallace Lodge exterior" },
      { src: "/images/properties/lodge-living-room.jpg", alt: "Living room with leather Chesterfield sofas" },
      { src: "/images/properties/lodge-dining-room.jpg", alt: "Dining room with stone fireplace" },
      { src: "/images/properties/lodge-kitchen.jpg", alt: "Full kitchen with island" },
      { src: "/images/properties/lodge-master-bedroom.jpg", alt: "Master bedroom with vaulted cedar ceiling" },
      { src: "/images/properties/lodge-bedroom-2.jpg", alt: "Bedroom with herringbone wood paneling" },
      { src: "/images/properties/lodge-twin-bedroom.jpg", alt: "Twin bedroom" },
      { src: "/images/properties/lodge-master-bath.jpg", alt: "Master bathroom with soaking tub" },
    ...
    cottage: [
      { src: "/images/properties/lodge.jpg", alt: "Bonnie Lass Cottage exterior" },
      { src: "/images/properties/cottage-kitchen.jpg", alt: "Kitchen with spiral staircase to loft" },
      { src: "/images/properties/cottage-living-room.jpg", alt: "Living room with garage door and forest views" },
      { src: "/images/properties/cottage-master-bedroom.jpg", alt: "Master bedroom with forest window" },
      { src: "/images/properties/cottage-loft-bedroom.jpg", alt: "Loft bedroom with cowhide pillows" },
      { src: "/images/properties/cottage-bathroom.jpg", alt: "Bathroom with glass shower and dark tile" },
      { src: "/images/properties/cottage-exterior-2.jpg", alt: "Cottage exterior with gambrel roof" },
      { src: "/images/properties/cabin-interior.jpg", alt: "Cozy cabin bedroom" },
    ],
    camp: [
